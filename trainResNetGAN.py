...
class Trainer():
    def __init__(self):
        ...
        net = importlib.import_module("models." + "resnetGAN")
        ...
        self.tensorboard_directory = r'C:\Aakrit\College\8th Sem\Major Project\aotgan(scratch)\tensorboard_logs\resnetGAN'
        self.model_save_directory = r'C:\Aakrit\College\8th Sem\Major Project\aotgan(scratch)\model_directory\resnetGAN'
