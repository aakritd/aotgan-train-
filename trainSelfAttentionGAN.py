...
class Trainer():
    def __init__(self):
        ...
        net = importlib.import_module("models." + "selfAttentionGAN")
        ...
        self.tensorboard_directory = r'C:\Aakrit\College\8th Sem\Major Project\aotgan(scratch)\tensorboard_logs\selfAttentionGAN'
        self.model_save_directory = r'C:\Aakrit\College\8th Sem\Major Project\aotgan(scratch)\model_directory\selfAttentionGAN'
