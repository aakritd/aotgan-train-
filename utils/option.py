...
# data specifications
parser.add_argument("--dir_image", type=str, default=r"C:\Aakrit\College\8th Sem\Major Project\Image Inpainting\AOT-GAN-for-Inpainting-finetune\AOT-GAN-for-Inpainting-finetune\examples\face\image", help="image dataset directory")
...
parser.add_argument("--pre_train", type=str, default=r"C:\Aakrit\College\8th Sem\Major Project\Image Inpainting\AOT-GAN-for-Inpainting-finetune\AOT-GAN-for-Inpainting-finetune\finetuning\lr0.00001(1200iters)\G.pt", help="path to pretrained models")
parser.add_argument("--outputs", type=str, default=r"C:\Aakrit\College\8th Sem\Major Project\Image Inpainting\AOT-GAN-for-Inpainting-finetune\AOT-GAN-for-Inpainting-finetune\src\outputs", help="path to save results")
